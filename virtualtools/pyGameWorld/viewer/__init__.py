...
__all__ = ['drawWorld', 'demonstrateWorld', 'demonstrateTPPlacement',
           ...
           'drawMultiPathSingleImage', 'drawMultiPathSingleImageBasic', 'drawSingleImageWithPlacement']
...
def drawSingleImageWithPlacement(tp, pathSize=3, lighten_amt=.5, worlddict=None, with_tools=False):
    # set up the drawing
